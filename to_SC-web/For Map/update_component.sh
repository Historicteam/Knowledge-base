...
base_path=../geometry.drawings/src
...
cp -fv $base_path/client/static/common/jsxgraphcore.js $jsx_path/
cp -fv $base_path/client/static/common/jsxgraphsrc.js $jsx_path/
...
#! added * to send all new components. Not just drawings
cp -Rfv $base_path/components/*/static/* $sc_web_static_path
#! ----

stage "Install component"
#! path chenged to append link of all js-files. Not just drawings
for component in ../geometry.drawings/src/components/*/static/components/js/*; do 
append_js $sc_web_path/templates/components.html components/js/$(basename $component)/$(basename $component).js
done
#! ----
